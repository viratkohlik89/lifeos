...
slip at all.` },
  ...
  const State = {
    ...
    demoWorkspace() {
      return this._reconcile({ tasks: [], projects: [], goals: [], habits: [], upcoming: [], notes: [], journal: [], inbox: [], time: [], activity: [], transactions: [], files: [], automations: [], templates: [], focus: [], reviews: [], user: { name: '', focus: [], onboardedAt: null }, finance: { currency: 'USD', budgets: {} } });
    },
